...
J_ranges = np.array([0, 7.5, 30])

# a0 arrays
a0_j = np.array([
    [4.0187E-17, 3.8926E-17],   # J0→3
    [1.4095E-17, -5.9277E-16]   # J0→4
])

# a1 arrays
a1_j = np.array([
    [-3.4332E-17, 3.3496E-18],
    [-3.8437E-18, 1.577E-16]
])

# a2 arrays
a2_j = np.array([
    [9.5048E-18, 1.8872E-19],
    [1.8777E-18, -1.1631E-17]
])
...
# slope and offset arrays (for linear ranges >=30)
slope_j = np.array([-0.64194, -1.2547])
offset_j = np.array([-34.3436, -32.873])
